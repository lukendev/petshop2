...
let todosPets = darEntradaPets(json, lerPets, vacinarPet);
//console.log(todosPets)

// Criar função que filtre o pet pelo nome

//let filtrarPeloNome = todosPets.filter( pet => pet.nome == "Menino")
//let filtrarPeloNome = todosPets.filter( pet => pet.nome.indexOf("Menino") != -1);
let filtrarPeloNome = texto => todosPets.filter( pet => pet.nome.indexOf(texto) != -1);


console.log(filtrarPeloNome(todosPets, "Menino"))